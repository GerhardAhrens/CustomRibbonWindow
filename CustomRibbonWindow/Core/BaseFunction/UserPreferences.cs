//-----------------------------------------------------------------------
// <copyright file="UserPreferences.cs" company="PTA GmbH">
...
namespace CustomRibbonWindow.Core
{
    ...
    public class UserPreferences : DisposableBase
    {
        public UserPreferences(SettingsLocation settingsLocation = SettingsLocation.AssemblyLocation)
        {
